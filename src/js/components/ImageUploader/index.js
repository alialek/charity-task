   ...
   */
	renderIcon() {
		if (this.props.withIcon) {
			return (
				<div className="fileUploader-placeholder" type={this.props.buttonType} onClick={this.triggerFileUpload}>
					<div className="fileUploader-placeholder-inner"> {this.props.buttonText}</div>
				</div>
			);
		}
	}
		...
		return (
			<div className="uploadPicturesWrapper">
				<FlipMove enterAnimation="fade" leaveAnimation="fade" style={styles}>
					{this.props.singleImage ? this.renderPreviewPicture() : this.renderPreviewPictures()}
				</FlipMove>
			</div>
		);
	}
		...
		return this.state.pictures.map((picture, index) => {
			return (
				<div
					...
					className="fileUploader-placeholder--uploaded"
				>
		...
		return (
			<div className={'fileUploader ' + this.props.className} style={this.props.style}>
				<div className="fileContainer" style={this.props.fileContainerStyle}>
					{this.state.pictures.length === 0 && this.renderIcon()}
